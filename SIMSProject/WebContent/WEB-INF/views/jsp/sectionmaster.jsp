...
<body>
	...
	<form:form method="POST" commandName="section"
		action="savesection">
		<table>
					<tr>
				<td><form:label path="sectionName">Section Name:</form:label></td>
				<td><form:input path="sectionName" value="${section.sectionName}" /></td>
			</tr>
			<tr>
				<td><form:label path="sectionAliasName">Alias Name:</form:label></td>
				<td><form:input path="sectionAliasName" value="${section.sectionAliasName}" /></td>
			</tr>
			<tr>
				<td><form:label path="sectionCode">Section Code:</form:label></td>
				<td><form:input path="sectionCode" value="${section.sectionCode}" /></td>
			</tr>
			<tr>
