				...
				<div class="col-sm-12">
					<div class="card">
						<div class="card-header">
							<strong>Ware House Master</strong>
						</div>
						<div class="col-sm-6">
...
<body>
	<h2>Add Ware House Data</h2>
	<form:form method="POST" commandName="wareHouse"
		action="savewarehouse">
		<table>
					<tr>
				<td><form:label path="wareHouseName">wareHouse Name:</form:label></td>
				<td><form:input path="wareHouseName" value="${wareHouse.wareHouseName}" /></td>
			</tr>
			<tr>
				<td><form:label path="aliasName">Alias Name:</form:label></td>
				<td><form:input path="aliasName" value="${wareHouse.aliasName}" /></td>
			</tr>
			<tr>
				<td><form:label path="wareHouseCode">WareHouse Code:</form:label></td>
				<td><form:input path="wareHouseCode" value="${wareHouse.wareHouseCode}" /></td>
			</tr>
			<%--  <tr>
