...
<body>
	...
	<form:form method="POST" commandName="employee"
		...
		<table>
				...
				<td><form:input path="employeeName" value="${employee.employeeName}" /></td>
			</tr>
			<tr>
				<td><form:label path="empAliasName">Alias Name:</form:label></td>
				<td><form:input path="empAliasName" value="${employee.empAliasName}" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td><form:label path="empDOJ">Employee DOJ:</form:label></td>
